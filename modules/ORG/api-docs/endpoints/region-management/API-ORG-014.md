# POST /api/v1/org/regions/search

**Search Regions**

بحث في المناطق

Operation ID: `API-ORG-014`

**Authentication**

Required (Bearer Authentication).

**Required permission(s)**: REGION_VIEW (found on service:RegionService)

## Request Body

Schema: `RegionSearchRequest` (application/json)
...
Shape: `paginated list of RegionResponse (see Pagination Envelope in index.md)`
