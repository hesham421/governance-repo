# POST /api/v1/org/branches/search

**Search Branches**

بحث في الفروع

Operation ID: `API-ORG-008`

**Authentication**

Required (Bearer Authentication).

**Required permission(s)**: BRANCH_VIEW (found on service:BranchService)

## Request Body

Schema: `BranchSearchRequest` (application/json)
...
Shape: `paginated list of BranchResponse (see Pagination Envelope in index.md)`
