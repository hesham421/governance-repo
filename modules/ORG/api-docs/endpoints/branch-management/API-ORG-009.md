# PUT /api/v1/org/branches/{id}

**Update Branch**

تحديث فرع

Operation ID: `API-ORG-009`
...
Schema: `BranchUpdateRequest` (application/json)

| Field | Type | Required | Constraints | Description | Example |
|---|---|---|---|---|---|
| nameAr | string | No | maxLength: 200 | Arabic name - الاسم بالعربية | الفرع الرئيسي |
| nameEn | string | No | maxLength: 100 | English name - الاسم بالإنجليزية | Main Branch |
| branchTypeId | string | No | maxLength: 50 | Branch type code (LOV-ORG-002) - نوع الفرع | MAIN_BRANCH |
